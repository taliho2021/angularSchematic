...
import { ImportTableDataSource, ImportTableItem } from './import-table-datasource';
...
export class ImportTableComponent implements AfterViewInit {
  ...
  @ViewChild(MatTable) table!: MatTable<ImportTableItem>;
  ...
  constructor() {
    this.dataSource = new ImportTableDataSource();
  }
